...
function applyStartupParameters() {
  ...
  let shouldResetForScenario = false;

  if (scenarioId && SCENARIO_PRESETS.some((preset) => preset.id === scenarioId)) {
    scenarioSelect.value = scenarioId;
    shouldResetForScenario = true;
  }
