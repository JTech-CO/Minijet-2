...
import { FaultCode, StartBlockReason } from "../index.js";
...
export function getFaultRecoveryGuidance(fault               )                   {
  switch (fault) {
...
export function getStartBlockGuidance(reason                      )                          {
  switch (reason) {
...
export function getActiveRecoveryGuidance(telemetry                 )                          {
