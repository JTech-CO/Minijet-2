...
import { EngineMode, FaultCode, StartBlockReason } from "../engine/index.js";
...
function value(
  ...
  normalized        ,
  formatted        ,
  status                       = InstrumentStatus.Nominal
)                  {
  return {
    id,
    label,
...
function egtStatus(telemetry                 , spec            )                       {
...
function rpmStatus(telemetry                 , spec            )                       {
...
function batteryStatus(telemetry                 , spec            )                       {
...
function surgeStatus(telemetry                 )                       {
...
function buildAnnunciators(telemetry                 )                {
  const annunciators                = telemetry.faults.map((fault) => ({
    id: `fault:${fault}`,
...
export function createGraphSample(telemetry                 , spec            , timeS        )              {
  return {
    timeS,
    values: {
