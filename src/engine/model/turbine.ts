import type { EngineSpec, EngineState, TurbineResult } from "./types.ts";
import { CP_GAS_J_PER_KG_K, clamp, rpmToRadPerSec } from "./units.ts";

export function computeTurbineTorque(state: EngineState, spec: EngineSpec): TurbineResult {
