import type { EcuCommand, EngineSpec, EngineState, SpoolResult } from "./types.ts";
import { clamp, radPerSecToRpm, rpmToRadPerSec } from "./units.ts";
import { computeBatteryAuthority } from "./fuelSystem.ts";
